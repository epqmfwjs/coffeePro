...
%>
	<div align="right" style="color:white;">
	  <strong><%= session.getAttribute("AUTH_USER_ID") %></strong> 님 안녕하세요
...
<%}%>
<!-- ------------------------------------로그인 유지와 유효성--------------------------------------------- -->
<p style="color:white; font-size:2.5rem;">Dinosaur Library</p>
     <!-- ---------------네비바--------------------------------- -->
	<nav>
		<ul>
			<li class="dropdown">
	  ...
	  <%}else{%>
	    <li>
	      ...
	      <ul>
	        ...
	        <li><a href="<%= request.getContextPath()%>/mainDino/management/join.jsp">회원가입</a></li>
	        <li><a href="#"></a></li>
	        <li><a href="#"></a></li>
	      </ul>
	    </li>
